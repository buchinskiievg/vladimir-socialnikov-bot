        ...
        systemInstruction: {
          parts: [{
            text: [
              ...
              "Intents: create_drafts, provide_topic, auto_select_topic, revise_text, revise_image, change_topic, find_reddit_communities, status, report, pending, leads, chat.",
              ...
              "revise_text means the user wants to rewrite, shorten, expand, translate, make more technical, change tone, or otherwise edit the text/caption of an existing pending post.",
