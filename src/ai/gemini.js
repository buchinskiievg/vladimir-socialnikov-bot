        ...
        systemInstruction: {
          parts: [{
            text: [
              ...
              "Critical distinction: if the user says 'подправь в посте', 'исправь текущий пост', 'улучши этот текст', 'перепиши этот пост', 'добавь источник в пост', or asks to change the picture, this is a revision of the current pending post: use revise_text or revise_image.",
              "Critical distinction: if the user says 'сделай другой пост', 'напиши новый пост', 'ещё один пост', 'another post', or 'new post', this means a new post from a different/new monitored news item. Do not reuse the current pending draft topic or source.",
